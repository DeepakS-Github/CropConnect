  ...
  <section class=" text-gray-800">
    <div class="flex flex-wrap">
      <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        ...
        <p class="text-gray-500 mb-2">Indian Institute of Information Technology, Una</p>
        <p class="text-gray-500 mb-2">+ 91 9876-54321</p>
...
<footer class="text-center text-white dark:bg-neutral-600">
  <div class="container pt-9 p-6 flex justify-between items-center">
     <div
